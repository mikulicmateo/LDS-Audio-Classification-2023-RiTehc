...
training_dataset_path = r'/home/dominik/Work/Lumen Datascience/LDS-Audio-Classification-2023-RiTehc/IRMAS_Training_Data'
os.chdir(training_dataset_path)

folders = ['tru', 'gac', 'sax', 'cel', 'flu', 'gel', 'vio', 'cla', 'pia', 'org', 'voi']
columns = ['path', 'tru', 'gac', 'sax', 'cel', 'flu', 'gel', 'vio', 'cla', 'pia', 'org', 'voi', 'genre']
...
pd.DataFrame(files, columns=columns).to_csv('training_annotation_file_with_genres.csv')